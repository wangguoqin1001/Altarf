...
Refinery::Pages.configure do |config|
  ...
  # config.auto_expand_admin_tree = true
   ...
   config.view_template_whitelist = ["home", "news-qzz","mdorder","plzregister","member-right","story-about-qzz","introduce-qzz","member-activities","news-qzz-all-words","order-success","future-qzz"]
