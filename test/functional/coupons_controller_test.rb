...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { coupon: @coupon.coupon, discount: @coupon.discount, percentage_off: @coupon.percentage_off, sku: @coupon.sku }
    end
  ...
  test "should update coupon" do
    put :update, id: @coupon, coupon: { coupon: @coupon.coupon, discount: @coupon.discount, percentage_off: @coupon.percentage_off, sku: @coupon.sku }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
